...
const BlogIndex = (props) => {
      ...
      },
      {
        ...
        cell: (cell) => {
          ...
          return (
            <React.Fragment>
              {value === 0 ? (
                <span className="badge bg-success-subtle text-success badge-border me-5">
                  0 View
                </span>
              ) : value >= 1 && value <= 70 ? (
  ...
  document.title = "Review Manager";
  return (
    <React.Fragment>
      <div className="page-content">
        <Container fluid>
          <BreadCrumb title="Review Management" pageTitle="Review" />
          <Row>
            <Col lg={12}>
                ...
                <CardHeader className="border-0">
                  <Row className="g-4 align-items-center">
                    <div className="col-sm">
                      <div>
                        <h5 className="card-title mb-0">Review Manager</h5>
                      </div>
                    </div>
